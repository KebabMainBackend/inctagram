...
import { PrismaService } from "../../inctagram/src/prisma.service";
...
import { customerCreate } from "../../inctagram/src/features/stripe/app/customer-create";
...
export class PaymentsService {
  ...
  async addNewProductToStripe(payload: addNewSubscriptionTypeDto) {
    ...
    const productPrice =
      await stripe.prices.create({ ...defaultPriceDto });
